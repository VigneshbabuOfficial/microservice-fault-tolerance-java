...
public class CircuitBreakerController {
	...
	@CircuitBreaker(name = "getInvoiceCB", fallbackMethod = "getInvoiceFallbackForRetryForCB")
	public String getInvoiceCB() {
		logger.info("getInvoiceCB() call starts here");
	...
	public String getInvoiceFallbackForRetryForCB(Exception e) {
